...
hcallayout(dqmitems, 'SumQvsLS/DIGI/SubdetPM/HBM', [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HBM', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsLS/DIGI/SubdetPM/HBP', [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HBP', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsLS/DIGI/SubdetPM/HEM', [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HEM', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsLS/DIGI/SubdetPM/HEP', [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HEP', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsLS/DIGI/SubdetPM/HFM', [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HFM', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsLS/DIGI/SubdetPM/HFP', [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HFP', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsLS/DIGI/SubdetPM/HOM', [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HOM', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsLS/DIGI/SubdetPM/HOP', [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HOP', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])
...
hcallayout(dqmitems, 'SumQvsBX/DIGI/SubdetPM/HBM', [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HBM', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsBX/DIGI/SubdetPM/HBP', [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HBP', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsBX/DIGI/SubdetPM/HEM', [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HEM', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsBX/DIGI/SubdetPM/HEP', [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HEP', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsBX/DIGI/SubdetPM/HFM', [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HFM', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsBX/DIGI/SubdetPM/HFP', [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HFP', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsBX/DIGI/SubdetPM/HOM', [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HOM', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'SumQvsBX/DIGI/SubdetPM/HOP', [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HOP', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])
...
hcallayout(dqmitems, 'MsnCutDatavsBX/TP/TTSubdet/HBHE', [{'path':'Hcal/TPTask/MsnCutDatavsBX/TTSubdet/HBHE', 'description':"""Number of Channels missing from Data w.r.t. Emulator vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'MsnCutDatavsBX/TP/TTSubdet/HF', [{'path':'Hcal/TPTask/MsnCutDatavsBX/TTSubdet/HF', 'description':"""Number of Channels missing from Data w.r.t. Emulator vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])
...
hcallayout(dqmitems, 'EtCorrRatiovsLS/TP/TTSubdet/HBHE', [{'path':'Hcal/TPTask/EtCorrRatiovsLS/TTSubdet/HBHE', 'description':"""Et Correlation Ratio vs LS <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'EtCorrRatiovsLS/TP/TTSubdet/HF', [{'path':'Hcal/TPTask/EtCorrRatiovsLS/TTSubdet/HF', 'description':"""Et Correlation Ratio vs LS <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])
...
hcallayout(dqmitems, 'MsnCutDatavsLS/TP/TTSubdet/HBHE', [{'path':'Hcal/TPTask/MsnCutDatavsLS/TTSubdet/HBHE', 'description':"""Number of Channels missing from Data w.r.t. Emulator vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'MsnCutDatavsLS/TP/TTSubdet/HF', [{'path':'Hcal/TPTask/MsnCutDatavsLS/TTSubdet/HF', 'description':"""Number of Channels missing from Data w.r.t. Emulator vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'MsnCutEmulvsLS/TP/TTSubdet/HBHE', [{'path':'Hcal/TPTask/MsnCutEmulvsLS/TTSubdet/HBHE', 'description':"""Number of Channels missing from Emulator w.r.t. Data vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'MsnCutEmulvsLS/TP/TTSubdet/HF', [{'path':'Hcal/TPTask/MsnCutEmulvsLS/TTSubdet/HF', 'description':"""Number of Channels missing from Emulator w.r.t. Data vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'MsnCutEmulvsBX/TP/TTSubdet/HBHE', [{'path':'Hcal/TPTask/MsnCutEmulvsBX/TTSubdet/HBHE', 'description':"""Number of Channels missing from Emulator w.r.t. Data vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'MsnCutEmulvsBX/TP/TTSubdet/HF', [{'path':'Hcal/TPTask/MsnCutEmulvsBX/TTSubdet/HF', 'description':"""Number of Channels missing from Emulator w.r.t. Data vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])
...
hcallayout(dqmitems, 'EtCorrRatiovsBX/TP/TTSubdet/HBHE', [{'path':'Hcal/TPTask/EtCorrRatiovsBX/TTSubdet/HBHE', 'description':"""Et Correlation Ratio vs BX <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, 'EtCorrRatiovsBX/TP/TTSubdet/HF', [{'path':'Hcal/TPTask/EtCorrRatiovsBX/TTSubdet/HF', 'description':"""Et Correlation Ratio vs BX <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#TP_Task_Description'>Details...</a>"""}])
...
hcallayout(dqmitems, '11 DIGI Amplitude vs LS', [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HBM', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}, {'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HBP', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}, {'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HEM', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}], [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HEP', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}, {'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HFM', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}, {'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HFP', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}], [{'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HOM', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}, {'path':'Hcal/DigiTask/SumQvsLS/SubdetPM/HOP', 'description':"""Total charge per channel per event vs LS.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])

hcallayout(dqmitems, '12 DIGI Amplitude vs BX', [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HBM', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}, {'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HBP', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}, {'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HEM', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}], [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HEP', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}, {'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HFM', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}, {'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HFP', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}], [{'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HOM', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}, {'path':'Hcal/DigiTask/SumQvsBX/SubdetPM/HOP', 'description':"""Total charge per channel per event vs BX.  <a href='https://twiki.cern.ch/twiki/bin/view/CMS/HcalDQMRun2TaskDescription#Digi_Task_Description'>Details...</a>"""}])
